...
var chart = am4core.create("cheesechartdiv", am4maps.MapChart);
...
try {
    ...
    chart.raiseCriticalError(new Error("El mapa no podrá ser cargado. Por favor descargue la última versión <a href=\"https://www.amcharts.com/download/download-v4/\">geodata amcharts</a> y extraiga su contenido en el mismo directorio que sus ficheros amCharts."));
}
...
polygonSeries.include = ["CN", "IN", "BD", "EG", "KR", "RU", "MM", "UA", "UZ", "ES", "US", "AR"]
